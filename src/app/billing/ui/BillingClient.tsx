      ...
      <div className={`${showCheckout ? 'opacity-100 translate-y-0' : 'opacity-0 pointer-events-none -translate-y-2'} transition-all duration-300`}>
        {showCheckout && (
          <div className="space-y-3">
            <button onClick={handleBackToPlans} className="inline-flex items-center sm:pl-8 sm:mt-10 font-semibold text-sm text-gray-900 hover:text-black">
            ...
            <div id="checkout" className="w-full mt-8">
              {!clientSecret && (
