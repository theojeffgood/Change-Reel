          ...
          <div className="lg:col-span-1">
            <div className="text-center">
              <div className="inline-flex flex-col items-center space-y-3">
                <button
                  onClick={() => signIn('github', { callbackUrl: '/config' })}
                  className="inline-flex items-center mt-6 px-10 py-3 bg-black text-white hover:bg-gray-800 rounded-4xl transition-colors font-semibold"
                >
