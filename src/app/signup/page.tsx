            ...
            <div className="text-center">
              <div className="inline-flex flex-col items-center space-y-3">
                <a
                  ...
                  className={`inline-flex items-center mt-6 px-6 py-3 ${installUrl ? 'bg-black text-white hover:bg-gray-800' : 'bg-gray-400 text-white'} rounded-4xl transition-colors font-semibold`}
                >
                  ...
                  {installUrl ? 'Connect your Account' : 'Install URL not configured'}
                </a>
              </div>
